...
<footer class="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900 mt-[100px]">
  <div class="sm:flex sm:items-center sm:justify-between">
      <a href="index.php" class="flex items-center mb-4 sm:mb-0">
          <img src="<?=URLROOT?>/assets/image/Untitled_design_1_-removebg-preview.png" class="mr-3 h-8" alt="Flowbite Logo" />
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
      </a>
      <ul class="flex flex-wrap items-center mb-6 text-sm text-gray-500 sm:mb-0 dark:text-gray-400">
          <li>
              <a href="<?=URLROOT?>/Pages/about" class="mr-4 hover:underline md:mr-6 ">About</a>
          </li>
          <li>
          ...
          <li>
              <a href="<?=URLROOT?>/Pages/contact" class="hover:underline">Contact</a>
          </li>
      </ul>
  </div>
