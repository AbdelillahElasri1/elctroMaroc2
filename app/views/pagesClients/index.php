      ...
      <div id="indicators-carousel" class="relative bg-gray-200" data-carousel="static">
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                <img src="../../../public/assets/image/pexels-karol-d-325153.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="../../../public/assets/image/pexels-fauxels-3183132.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="../../../public/assets/image/slide.png" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
            </div>
            <!-- Item 4 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="../../../public/assets/image/pexels-fauxels-3183132.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
  ...
  <div class="services">
    ...
    <div class="container flex gap-0.5 justify-around">
          <div class="cl w-[350px] h-[350px] bg-slate-100 flex-col gap-x-2.5">
            ...
            <img class="w-[350px] h-[200px] mt-11" src="../../../public/assets/image/pexels-fauxels-3183132.jpg" alt="">
          </div>
